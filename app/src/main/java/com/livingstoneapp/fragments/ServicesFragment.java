...
import com.livingstoneapp.adapters.ServicesAdapter;
 ...
 */
public class ServicesFragment extends Fragment implements IServicesFragmentView {
    private static final String ARG_PACKAGE_NAME = "package_name_param";

    @Inject
    IServicesFragmentPresenter mPresenter;
     ...
     */
    public static ServicesFragment newInstance(String packageName) {
    ...
    @Override
    public void setModel(ArrayList<ServiceInfoInternal> permissions) {

        recyclerView.setHasFixedSize(true);

        recyclerView.addItemDecoration(new DividerItemDecoration(getActivity(), DividerItemDecoration.VERTICAL_LIST));

        mAdapter = new ServicesAdapter(permissions);
