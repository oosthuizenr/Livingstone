 ...
 */
public class ContentProvidersAdapter extends RecyclerView.Adapter<ContentProvidersAdapter.ViewHolder> {

    private RecyclerViewOnClickListener<ContentProviderInfo> mListener;


    protected List<ContentProviderInfo> mData;

    public ContentProvidersAdapter(List<ContentProviderInfo> data) {
        mData = data;
    }

    public void setOnClickListener(RecyclerViewOnClickListener<ContentProviderInfo> listener) {
        ...
        return
                new ViewHolder(
                        LayoutInflater.from(parent.getContext())
                                .inflate(R.layout.app_info_content_providers_adapter_layout, parent, false),
                        position -> {
                            if (mListener != null) {
