...
public class RequestedFeaturesFragmentPresenterImpl implements IRequestedFeaturesFragmentPresenter {
    ...
    public RequestedFeaturesFragmentPresenterImpl(IPackageInteractor interactor) {
        mInteractor = interactor;
    }

    @Override
    public void setView(IRequestedFeaturesFragmentView view) {
        mView = view;
    }
    ...
    public void init(String packageName) {
        ...
        mInteractor.getRequestedFeatures(packageName)
